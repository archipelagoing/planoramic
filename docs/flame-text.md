...
an outer glow. Dark mode adds a tight dark drop shadow for contrast. Real DOM
...
and resizing are observed automatically. Pass `{dark: true}` for the contrast shadow.
